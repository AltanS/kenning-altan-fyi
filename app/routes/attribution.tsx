      ...
      <dl className="mt-3 space-y-1">
        <Field label={t('attribution.licenceLabel')}>
          ...
          {licenceUrl !== undefined && (
            <a href={licenceUrl} rel="noreferrer" target="_blank" className="text-brand-ink underline-offset-2 underline">
              {source.licence}
            </a>
          )}
        </Field>
        ...
        {source.url !== null && (
          <Field label={t('attribution.urlLabel')}>
            <a href={source.url} rel="noreferrer" target="_blank" className="text-brand-ink underline-offset-2 underline">
              {source.url}
            </a>
          </Field>
        )}
